...
#    b2=b[(-90<=b.phi) & (b.phi<=90)]
    ...
    for phi in np.arange(-90+7.5,90,7.5):
        ...
        comp2.to_csv('/Volumes/easystore/openggcm_run/Msh_Nstep/modeling/comp_phi_%.1f_' % phi+str(1200+1200*i).zfill(6),float_format='%.3f')
        ...
        fig.savefig('/Volumes/easystore/openggcm_run/Msh_Nstep/modeling/plots/comp/comp_%d_phi_%.1f.png' % (20*i+20,phi))
        plt.close()
